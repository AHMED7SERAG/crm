        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ->addColumn('actions', function ($row){
                    $btn = '<a href="'. route('admin.settings.edit', $row->id) .'" class="btn btn-success btn-sm"><i class="la la-lg la-pencil-square-o"></i> </a>';
                    ...
                    $btn .= '<button type="submit" class="btn btn-danger btn-sm  btn-jinja-delete"><i class="la la-lg la-trash"></i> </button>';
                    $btn .= '</form>';
                    return $btn;
                })
                ->rawColumns(['actions'])
