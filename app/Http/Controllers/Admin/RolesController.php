        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ->addColumn('actions', function ($row){
                    $btn = '<a href="'. route('admin.roles.edit', $row->id) .'" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>';
                    $btn .= '<a href="'. route('admin.roles.show', $row->id) .'" class="btn btn-primary btn-sm ml-1 mr-1"><i class="fa  fa-eye"></i> </a>';
